  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Padding(
          padding:
              const EdgeInsets.only(left: 50, top: 15, bottom: 15, right: 50),
          child: Row(
            children: [
              Expanded(
                  flex: 2,
                              ...
                              showDialog(
                                ...
                                builder: (context) => CustomModal(
                                  ...
                                  onAddToCartPressed: () {
                                    ...
                                    Map<String, String> cartObject = {
                                      "productName": product.name,
                                      "productPrice": product.price.toString(),
                                      "imageUrl": product.imageUrl,
                                      "quantity": capturedQuantity.toString(),
                                    };

                                    cartBloc.addProductToCart(cartObject);
                                  },
                                ),
                              );
                            },
